...
namespace Shop
{
    public partial class SellingForm : Form
    {
        ...
        //SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\PC\Documents\shop.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        private void calculate_Click(object sender, EventArgs e) 
        {
            ...
            else
            {
                ...
                {
                    change.Text = "Php " + Convert.ToString(Convert.ToInt32(paid.Text) - Convert.ToInt32(Gtotal));
                }
            }
        }
        ...
        {
            e.Graphics.DrawString("SARI-SARI STORE", new Font("Ariel", 30, FontStyle.Bold), Brushes.Maroon, new Point(250));
            ...
            string top2 = "********************************************************\n\n";
            string topunder = "--------------------------------------------------------\n\n";
            string top3 = "Item\tPrice(Php)\tQty\tTotal(Php)\n";
            string down = "***********************************************************\n";
            string downG = "Total:\t";
            string downP = "Paid:\t\t";
            string downC = "Change:\t";
